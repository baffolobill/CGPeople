...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('generic_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('bio', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities.Country'], null=True, blank=True)),
            ...
            ('available_for', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('generic', ['Profile'])

        # Adding model 'PortfolioSite'
        db.create_table('generic_portfoliosite', (
            ('id', self.gf('django.db.models.fields.AutoField')(max_length=11, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['generic.Profile'])),
        ))
        db.send_create_signal('generic', ['PortfolioSite'])


    def backwards(self, orm):
        
        # Deleting model 'Profile'
        db.delete_table('generic_profile')

        # Deleting model 'PortfolioSite'
        db.delete_table('generic_portfoliosite')
