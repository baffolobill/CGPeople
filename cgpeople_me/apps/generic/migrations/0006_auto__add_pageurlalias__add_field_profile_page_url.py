...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PageUrlAlias'
        db.create_table('generic_pageurlalias', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['generic.Profile'])),
            ('page_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('generic', ['PageUrlAlias'])

        # Adding field 'Profile.page_url'
        db.add_column('generic_profile', 'page_url', self.gf('django.db.models.fields.CharField')(default='blah', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'PageUrlAlias'
        db.delete_table('generic_pageurlalias')

        # Deleting field 'Profile.page_url'
        db.delete_column('generic_profile', 'page_url')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 11, 7, 36, 43, 956982)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 11, 7, 36, 43, 956823)'}),
