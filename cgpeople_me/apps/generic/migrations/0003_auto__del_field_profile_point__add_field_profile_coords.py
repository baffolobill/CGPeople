...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('generic_profile', 'point')

        # Adding field 'Profile.coords'
        db.add_column('generic_profile', 'coords', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.point'
        db.add_column('generic_profile', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Profile.coords'
        db.delete_column('generic_profile', 'coords')
